...
function Signup() {
  ...
  const submitSignup = async () => {
    try {
      const response = await axios.post('http://localhost:3000/signup', {
        ...
        Balance: 10000,
        Phone_no: parseInt(user_details.phone),
  ...
  return (
    <div className="relative h-full w-full flex justify-center items-center bg-[#CCD7F7]">
      <div className="relative h-[70%] w-[60%] border- rounded-3xl flex bg-white shadow-2xl 2xl:max-w-[1000px] 2xl:max-h-[800px] max-sm:w-[90%]">
        <div className="h-full w-full  max-xl:hidden">
          <div className="h-full w-full bg-[#5956B1] rounded-l-3xl rounded-r-[180px] flex justify-center items-center">
            <div className="flex flex-col text-center capitalize gap-5 items-center justify-center text-white">
        ...
        <div className="h-full w-full flex flex-col gap-5 items-center justify-center py-20">
          <div className="h-full w-full flex flex-col justify-end items-center gap-4">
            <h1 className="text-5xl capitalize font-semibold max-md:text-4xl max-sm:text-3xl max-2xl:text-4xl 2xl:text-4xl">
              create account
            </h1>
            ...
            <p className="max-sm:text-[12px]">or use your email for registration</p>
          </div>
          <div className="h-full w-full flex flex-col items-center gap-2 justify-center">
            <input
              type="text"
              className="h-10 w-[80%] bg-gray-200 focus:outline-blue-400 rounded-[5px] px-3 capitalize"
            ...
            <div className="text-[13px] capitalize">
              <p
                className="hover:text-red-400 mt-1"
                onClick={() => {
                  navigate("/");
                }}
              >
